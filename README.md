...
- 프로젝트 정의 : 실시간 낙상 예측 및 감지 시스템</br>
  <img width="800" height="800" alt="image" src="/title1.png" style="display:block;margin:0 auto" />
...
[![한이음 드림업 프로젝트 소개](/title2.png)](https://youtu.be/Z6AcirN5684?si=LVQE4deD56aUPQWe)
